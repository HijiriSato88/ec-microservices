...
type Product struct {
	...
	Price         int64                  `protobuf:"varint,4,opt,name=price,proto3" json:"price,omitempty"` // 円
...
const file_product_product_proto_rawDesc = "" +
	"\n" +
	"\x15product/product.proto\x12\aproduct\"e\n" +
	"\aProduct\x12\x0e\n" +
	...
	"\x05price\x18\x03 \x01(\x03R\x05price\"C\n" +
	"\x15CreateProductResponse\x12*\n" +
	"\aproduct\x18\x01 \x01(\v2\x10.product.ProductR\aproduct2\xf4\x01\n" +
	...
	"\rCreateProduct\x12\x1d.product.CreateProductRequest\x1a\x1e.product.CreateProductResponseB;Z9github.com/hijiri/ec-microservices/gen/go/product;productb\x06proto3"
...
var file_product_product_proto_depIdxs = []int32{
	...
	5, // 5: product.ProductService.CreateProduct:input_type -> product.CreateProductRequest
	...
	6, // 8: product.ProductService.CreateProduct:output_type -> product.CreateProductResponse
